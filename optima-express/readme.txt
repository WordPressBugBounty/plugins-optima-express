...
= 8.3.0 =
* Resolved issues with Block themes support

= 8.2.0 =
* Bug fixes for OmniPress updates
...
= 8.0.4 =
* Bug fix for critical error that caused a crash on the plugin for some users

= 8.0.3 =
* Bug fix for PlatformMismatchError
